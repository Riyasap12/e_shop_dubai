      ...
      Selector<UserProvider, String>(
        builder: (context, data, child) {
          ...
          return IconButton(
            icon: Stack(
              children: [
                Center(child: SvgPicture.asset(imagePath + "appbarCart.svg")),
...
Widget getNoItem(BuildContext context) {
  return Center(child: Text(getTranslated(context, 'noItem')!,   style: Theme.of(context).textTheme.subtitle2!.copyWith(
