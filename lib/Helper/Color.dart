...
extension colors on ColorScheme {
  ...
  Color get lightBlack =>
      this.brightness == Brightness.dark ? whiteTemp :  Color(0xff52575C);

  Color get lightBlack2 =>
      this.brightness == Brightness.dark ? Colors.white70 :  Color(0xff999999);
  ...
  Color get white70 => this.brightness == Brightness.dark?Colors.black87:Colors.white70;
