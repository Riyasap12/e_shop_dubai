  ...
  Future<void> getRegisterUser() async {
    ...
    print(data);
      ...
      if (!error) {
        ...
        settingProvider.saveUserDetail(id!, name, email, mobile, city, area, address, pincode,
            latitude, longitude, "",referCode,context);
  ...
  setPass() {
    return Padding(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            prefixIcon: SvgPicture.asset("assets/images/password.svg",height: 17,width: 17,color: Theme.of(context).colorScheme.fontColor,),
            // Icon(
            //   Icons.lock_outline,
