...
class _CustomerSupportState extends State<CustomerSupport> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: getSimpleAppBar(getTranslated(context, 'CUSTOMER_SUPPORT')!, context),
                    ...
                    GestureDetector(
                        child: Container(
                          ...
                          child: Text(
                            ...
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                                color: Theme.of(context).colorScheme.fontColor, fontSize: 11),
                          ),
                        ),
                        onTap: () {
                          setState(() {
