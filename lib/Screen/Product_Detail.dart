                    ...
                    child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: available!
                              ...
                              : null,
                          color: available! ? null : Theme.of(context).colorScheme.gray,
                        ),
              ...
              child: Row(
                children: [
                  OutlinedButton.icon(
                    ...
                    icon: Icon(Icons.compare, color: Theme.of(context).colorScheme.btnColor),
                    label: Text(""),
                  ...
                  Padding(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      icon: Icon(Icons.share, color: Theme.of(context).colorScheme.btnColor),
                      label: Text(""),
                      style: OutlinedButton.styleFrom(
                        side: BorderSide(color: Theme.of(context).colorScheme.btnColor),
                      ),
      ...
      for (int i = 0; i < widget.model!.tagList!.length; i++) {
        tagChip = ChoiceChip(
          ...
          label: Text(widget.model!.tagList![i],
              style: TextStyle(color: Theme.of(context).colorScheme.fontColor, fontSize: 11)),
          backgroundColor: Theme.of(context).colorScheme.fontColor.withOpacity(0.1),
