...
class StateRate extends State<ReviewList> {
  ...
  return Scaffold(
        ...
        /*     Selector<OrderProvider, List<OrderModel>>(
          selector: (_, provider) => provider.orders,
          builder: (context, orders, child) {
            if (orders.isNotEmpty) {
              for (var i = 0; i < orders.length; i++) {
                if (orders[i].itemList!.isNotEmpty) {
                  for (var j = 0; j < orders[i].itemList!.length; j++) {
                    if (widget.id == orders[i].itemList![j].productId) {
                        ...
                        Positioned(
                          ...
                          child: ClipRRect(
                            ...
                            child:
                              ...
                              image:
                                  NetworkImage(reviewList[index].userProfile!),
                              fit: BoxFit.fill,
                              height: 36,
                              width: 36,
                          ...
                          /*     CircleAvatar(
                              ...
                              //   ),
                              // ),
                            backgroundImage: NetworkImage(reviewList[index].userProfile!),
                          ),*/
                        ),
                      ],
                    ),
