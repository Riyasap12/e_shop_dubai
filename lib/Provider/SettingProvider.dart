...
class SettingProvider {
  ...
  String get referalCode => _sharedPreferences.getString(REFERCODE) ?? "";

  String get dynamicLink => _sharedPreferences.getString(DYNAMICLINK) ?? "";
  ...
  Future<void> saveUserDetail(
    ...
    waitList.add(_sharedPreferences.setString(REFERCODE, referalCode ?? ""));
    ...
    userProvider.setReferalCode(referalCode ?? "");
